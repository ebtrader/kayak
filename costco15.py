...
# Split the Description column into Price and Details based on the first 9 characters
df['Price'] = df['Description'].str[:9].str.strip()
df['Details'] = df['Description'].str[9:].str.strip()
